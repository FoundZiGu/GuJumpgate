...
- [shared/mail/cloudmail-utils.js](c:/Users/projectf/Downloads/codex注册扩展/shared/mail/cloudmail-utils.js)
...
4. 邮件读取统一走 `/api/public/emailList`，返回数据先经 `shared/mail/cloudmail-utils.js` 归一化，再复用现有验证码匹配与时间窗过滤逻辑。
...
- [shared/mail/hotmail-utils.js](c:/Users/projectf/Downloads/codex注册扩展/shared/mail/hotmail-utils.js)
- [shared/mail/microsoft-email.js](c:/Users/projectf/Downloads/codex注册扩展/shared/mail/microsoft-email.js)
...
- [shared/mail/luckmail-utils.js](c:/Users/projectf/Downloads/codex注册扩展/shared/mail/luckmail-utils.js)
...
- [shared/mail/mail-provider-utils.js](c:/Users/projectf/Downloads/codex注册扩展/shared/mail/mail-provider-utils.js)
...
- [shared/mail/mail2925-utils.js](c:/Users/projectf/Downloads/codex注册扩展/shared/mail/mail2925-utils.js)
...
1. `shared/accounts/managed-alias-utils.js` 是否仍是 `provide / receive` 的唯一共享语义来源
...
- [shared/mail/icloud-utils.js](c:/Users/projectf/Downloads/codex注册扩展/shared/mail/icloud-utils.js)
...
- iCloud 转发目标邮箱 provider 的 label、URL、source、inject 配置统一由 `shared/mail/mail-provider-utils.js` 输出。
